...
const sections = [
  ...
  { label: 'topbar.css', file: 'topbar.css' },
...
const bundled = [
  ...
  '/* Source files: public/beefree/{tokens,topbar,stage-toolbar,sidebar,tab-icons,block-tiles,block-icons,styles-panel}.css — run: npm run beefree:css */',
  '',
